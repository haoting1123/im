...
const privateChatHandler = (stanza) => {
  ...
  if (messageType) {
    ...
    // console.log('PC端不接受私人定制消息', retObj)
  ...
  if (chatType && chatType === 'secretChat') {
    console.log('PC端不接受密聊消息', retObj)
    return retObj
