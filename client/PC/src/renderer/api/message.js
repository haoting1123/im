...
export const getRemoteAreaInfo = (userName) =>
  request({
    url: '/syntoim/rest/user/storage',
    method: 'GET'
  })

export const resetRemoteMessageArea = (userName) =>
  request({
    url: '/syntoim/rest/user/storage/cleanmsg',
    method: 'PUT'
  })

export const resetRemoteFileArea = (userName) =>
  request({
    url: '/syntoim/rest/user/storage/cleanfile',
    method: 'PUT'
  })
