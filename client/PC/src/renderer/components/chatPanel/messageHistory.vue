<template>
  <el-dialog :visible.sync="dialogVisible" :append-to-body="true" width="530px" top="5vh" :modal="false"
             custom-class="system-setting-style" @close="doCloseDialog">
    ...
    <div slot="title" class="dialog-header"><h5>{{ channelName }}</h5></div>
